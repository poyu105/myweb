...
export default function Skill(){
    return(
        <section id="skill">
            <h1 className="text-4xl text-center border-t-2 border-b-2 sticky top-0 bg-slate-800">我的技能</h1>
            <div className="ms-3 p-2">
                <p className="my-2">目前的我主要專注在網頁開發，不過偶爾也會使用其他程式撰寫一寫小專案，以下是我所擁有的技能:</p>
                <div className="my-2">
                    <h2 className="text-2xl font-bold border-b-2 border-gray-500 inline-block my-2">網頁開發</h2>
                ...
                <div className="my-2">
                    <h2 className="text-2xl font-bold border-b-2 border-gray-500 inline-block my-2">程式能力</h2>
                    <ul className="list-disc ps-5">
                        <li>
                            <h3 className="text-xl inline-block">C#</h3>
                            <p className="my-2">熟悉使用C#進行Web App的開發，能夠在.NET環境下開發應用。</p>
                        </li>
                        <li>
                            <h3 className="text-xl inline-block">Javascript</h3>
                            <p className="my-2">熟悉Javascript語法，能夠進行前後端以及網頁動態內容開發，使用過包含React、Node.js、Express.js進行開發。</p>
                        </li>
                        <li>
                            <h3 className="text-xl inline-block">C/C++/Java</h3>
                            <p className="my-2">了解C/C++/Java程式語法，能夠進行物件導向設計或算法設計的工作，具備清晰的邏輯思考能力和編碼能力。</p>
                        </li>
                        <li>
                            <h3 className="text-xl inline-block">Python</h3>
                            <p className="my-2">擁有Python基礎，能夠進行簡單的機器學習、深度學習、影像辨識、網路爬蟲的專案開發。</p>
                        </li>
                    </ul>
                </div>
                <div className="my-2">
                    <h2 className="text-2xl font-bold border-b-2 border-gray-500 inline-block my-2">其他技能</h2>
                    <ul className="list-disc ps-5">
                        <li>
                            <h3 className="text-xl inline-block">版本控制和協作</h3>
                            <p className="my-2">使用過git進行版本控制，確保專案的可回復性。也能夠使用git進行協同工作，確保專案開發順利進行。</p>
                        </li>
                        <li>
                            <h3 className="text-xl inline-block">Unix/Linux環境</h3>
